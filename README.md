...
Hi, I'm **WSake** (Slientsake) 👋

- 🏢 Currently working as an **LLM Application Engineer**
- 🔬 Exploring how to integrate **LLM Agents** into medical imaging analysis & clinical diagnosis
- 📍 Based in **Hangzhou, Zhejiang**
- 💡 *"We cannot solve our problems with the same thinking we used when we created them."* — Einstein

> 📖 I used to share paper reading notes on my blog — there are many open-source projects that might help you!
> [![CSDN](https://img.shields.io/badge/→_Slientsakke的学习笔记-blue?style=for-the-badge)](https://blog.csdn.net/weixin_49627776?type=blog)
